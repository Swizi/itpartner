  ...
  useEffect(() => {
    if (props.activeModal === null) {
      ...
      if (props.filterOptions.design === true) {
        ex_partners = ex_partners.filter(function (
          filteredPartner,
          i,
          ex_partners
        ) {
      ...
      if (searchValue !== "") {
        ...
        ex_partners = ex_partners.filter(function (
          ...
          var first_last_name =
            filteredPartner.first_name + filteredPartner.last_name;
          var last_first_name =
            filteredPartner.last_name + filteredPartner.first_name;
          if (
            !(
            ...
            !(
              first_last_name.toLowerCase().indexOf(userVal.toLowerCase()) ===
              -1
            ) ||
            !(
              last_first_name.toLowerCase().indexOf(userVal.toLowerCase()) ===
              -1
            )
          ) {
